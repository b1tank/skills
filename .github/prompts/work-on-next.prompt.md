...
argument-hint: "[issue, bug, feature, or task]"
---
...
- If the user wants triage (labels, repro ask, owner routing, draft response) → invoke `@triager`.
...
- If changes affect UI/UX, request human verification steps (or use Playwright MCP for automated checks) before committing.
